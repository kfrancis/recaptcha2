...
namespace recaptcha
{
    ...
    public class Recaptcha
    {
        ...
        /// </remarks>
        public Recaptcha()
            : this(ConfigurationManager.AppSettings["GoogleRecaptchaSiteKey"], ConfigurationManager.AppSettings["GoogleRecaptchaSecretKey"])
        {
        }
        ...
        public RecaptchaValidationResult Validate(string recaptchaResponse)
        {
            ...
            var req = (HttpWebRequest)WebRequest.Create("https://www.google.com/recaptcha/api/siteverify?secret=" + SecretKey + "&response="
    ...
    public class RecaptchaValidationResult
    {
        ...
        {
            return string.Join(separator: "<br/>", value: ErrorMessages.ToArray());
        }
    }
}
